...
// Spawn enemies and set the corridor manager for each enemy
    ...
    private void handleShootInput() {
        ...
        if (input.isKeyPressed(shootKey1) || input.isKeyPressed(shootKey2) || isLeftMousePressed) {
            if (!isShooting) {
    ...
    // Add a method to handle mouse press events
    private void handleMousePress() {
        ...
        // Add a method to handle mouse release events
