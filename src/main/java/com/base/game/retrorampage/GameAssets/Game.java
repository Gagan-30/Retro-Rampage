...
/**
 * Main class to be extended for game projects. Creates the window and
 * {@link Group} objects, and manages the life cycle of the game (initialization
 * and game loop).
 */
public abstract class Game extends Application implements Screen {
    ...
    /**
     * Initializes the window and game objects, and manages the life cycle of
     * the game (initialization and game loop).
     */
